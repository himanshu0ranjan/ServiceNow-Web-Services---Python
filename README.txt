...
createIncident.py - This Python script creates a servicenow incident directly from the python3.6 script. This requires the python requests package so,
			before using requests you need to install the requests package for python3.6.
